...
(function($) {
  ...
  $.datepicker._doKeyPress = function(event) {
    ...
    if(tp_inst) {
      if($.datepicker._get(inst, "constrainInput")) {
        ...
        tp_inst._defaults.timezoneList.join("") : "") + tp_inst._defaults.amNames.join("") + tp_inst._defaults.pmNames.join("") + dateChars, chr = String.fromCharCode(event.charCode === undefined ? event.keyCode : event.charCode);
  ...
  $.datepicker._updateAlternate = function(inst) {
    ...
    if(tp_inst) {
      ...
      if(altField) {
        var altFormat = tp_inst._defaults.altFormat || tp_inst._defaults.dateFormat, date = this._getDate(inst), formatCfg = $.datepicker._getFormatConfig(inst), altFormattedDateTime = "", altSeparator = tp_inst._defaults.altSeparator ? tp_inst._defaults.altSeparator : tp_inst._defaults.separator, altTimeSuffix = tp_inst._defaults.altTimeSuffix ? tp_inst._defaults.altTimeSuffix : tp_inst._defaults.timeSuffix, altTimeFormat = tp_inst._defaults.altTimeFormat !== null ? tp_inst._defaults.altTimeFormat : 
...
(function($, undefined) {
  $(function() {
    $(".has-ui-datepicker").datepicker({showAnim:"slide", dateFormat:"yy-mm-dd"});
    $(".has-ui-datetimepicker").datetimepicker({showAnim:"slide", timeFormat:"HH:mm", dateFormat:"yy-mm-dd"})
  })
})(window.jQuery);
